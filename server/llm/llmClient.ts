...
export const llmModel = () => overrideModel('ollama') || process.env.LLM_MODEL || 'deepseek-r1:32b';
...
export function recordUsage(entry: Parameters<typeof recordLlmUsage>[0]): void {
...
// ---------- 模块拆分外观 re-export：保持统一入口 API 面不变（外部 import 路径零改动） ----------
export {
  pickOllamaBackend,
  probeOllamaBackend,
