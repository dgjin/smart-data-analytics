...
import { KNOWLEDGE_TOKEN_BUDGET } from '../llm/promptBudget';

vi.mock('../llm/llmClient', () => ({ callLLMJson: vi.fn() }));
vi.mock('../knowledge/knowledgeBase', () => ({ retrieveKnowledgeSnippets: vi.fn() }));
vi.mock('../query/metrics', () => ({
